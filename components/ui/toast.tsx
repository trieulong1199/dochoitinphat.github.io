...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Action ref={ref} className={cn('shrink-0 text-sm font-medium underline', className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ref={ref}
    className={cn('absolute right-2 top-2 rounded p-0.5 opacity-50 hover:opacity-100', className)}
    toast-close=""
    {...props}
  >
    <X size={14} />
